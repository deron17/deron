...
class Login(unittest.TestCase):
    ...
    def test_login(self):
        ...
        driver.find_element_by_id("signin_username").send_keys("qwe")
        driver.find_element_by_id("signin_password").send_keys("qweqwe")
        driver.find_element_by_link_text("Sign In").click()
        driver.find_element_by_link_text("OK").click()
        driver.find_element_by_id("signin_username").send_keys("onder")
        driver.find_element_by_id("signin_password").send_keys("asdasdasd")
        driver.find_element_by_link_text("Sign In").click()
        driver.find_element_by_link_text("OK").click()
