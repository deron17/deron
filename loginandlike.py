...
class Loginandlike(unittest.TestCase):
    ...
    def test_loginandlike(self):
        ...
        driver.find_element_by_id("qatab").click()
        driver.find_element_by_id("upcaretimga").click()
        driver.find_element_by_id("downcaretimga").click()
        driver.find_element_by_id("downcaretimga").click()
        driver.find_element_by_id("downcaretimga").click()
        driver.find_element_by_id("upcaretimga").click()
        driver.find_element_by_id("upcaretimga").click()
        driver.find_element_by_id("upcaretimga").click()
        driver.find_element_by_id("downcaretimga").click()
        driver.find_element_by_css_selector("div.span1 > span.muted > a.muted.padleft2  > i.icon-flag.opa50").click()
        driver.find_element_by_name("flaganswerreasonfrm").click()
        driver.find_element_by_link_text("Flag").click()
        driver.find_element_by_css_selector("div.span8.pull-right > div.row-fluid > div.span1 > span.muted > a.muted.padleft2  > i.icon-flag.opa50").click()
        driver.find_element_by_css_selector("div.span8.pull-right > div.row-fluid > div.span1 > span.muted > a.muted.padleft2  > i.icon-flag.opa50").click()
        driver.find_element_by_id("upcaretimgq").click()
        driver.find_element_by_css_selector("div.span8.pull-right > div.row-fluid > div.span1 > span.muted > a.muted.padleft2  > i.icon-flag.opa50").click()
        driver.find_element_by_xpath("//div[@id='questioncontent']/div[3]/div[2]/button").click()
        driver.find_element_by_id("answermessage").clear()
        driver.find_element_by_id("answermessage").send_keys("good")
